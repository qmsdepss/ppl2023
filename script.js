...
function renderUsers() {
    ...
    users = currentData.map(user => {
      ...
      <button id="dropdownDefaultButton" data-dropdown-toggle="${user._id}" class="text-white hover:text-white sm:flex md:hidden bg-black hover:bg-gray-600 focus:ring-4 focus:outline-none focus:ring-gray-500 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center" type="button"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-search text-slate-100" viewBox="0 0 16 16">
